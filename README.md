...
Welcome to **Pure Healthy Eats**, a complete full-stack e-commerce web application designed for a modern healthy food delivery service. This project provides a seamless online ordering experience for customers, from Browse a dynamic menu to making secure online payments.

**Live Demo:** `https://pure-healthy-eats-app.onrender.com` *(Replace with your actual Render URL)*
...
* Update the following lines with your MySQL username and password, and the database name you just created:
        ...
        spring.datasource.url=jdbc:mysql://localhost:3000/purehealthyeats_db?createDatabaseIfNotExist=true
...
* Copy the Key ID and Key Secret.In the application.properties file, add the following lines:
...
* Run the INSERT commands for the products to populate your menu.
